  ...
  action(msg) {
    ...
    msg.author.send(
      "WOOOAH twee-vwoop VRrrUHD DEda dah\n\n" +
        ...
        "`" +
        Singleton.prefix +
        "vote durée intitulé`: Permet de créer un sondage pour lequel les utilisateurs peuvent répondre par oui ou non\nExemples: `" +
        Singleton.prefix +
        "vote 30 Aimez-vous la couleur rouge ?`\n`" +
        Singleton.prefix +
        "vote 6m30 Aimez-vous la couleur bleue ?`\nAlias: `" +
        Singleton.prefix +
        "v durée intitulé`\n\n" +
        "`" +
        Singleton.prefix +
        ...
        "`" +
        Singleton.prefix +
        "tg`: Si vous faites cette commande je vous insulte\n\n" +
        "`" +
        Singleton.prefix +
        "ping`: Vous permet de connaître la latence que vous avez avec moi en millisecondes\n\n" +
        "`" +
        Singleton.prefix +
        "coinflip`: Je fais un Pile ou Face pour vous\nAlias: `" +
        Singleton.prefix +
        "cf`\n\n" +
        "`" +
        Singleton.prefix +
        'hot @utilisateur#0000 phrase quelconque`: Permet de proposer un défi à un utilisateur cible basé sur le jeu "Pour Combien ?" ou "Hot Combien ?"\nExemple: `' +
        Singleton.prefix +
        "hot @Fredo#8489 Pour combien tu supprimes ton serveur Discord` ?\nAlias: `" +
        Singleton.prefix +
        "cote @utilisateur#0000 phrase`\n\n" +
